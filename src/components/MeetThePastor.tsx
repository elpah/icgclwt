...
const MeetThePastor = () => {
  return (
    ...
    >
      <div className="absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-[#006B3F]/5 to-transparent" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative">
              <div className="relative z-10 rounded-3xl overflow-hidden shadow-2xl">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#006B3F]/40 to-transparent" />
              </div>

              <div className="absolute -top-6 -left-6 w-32 h-32 bg-gradient-to-br from-[#FFD700] to-[#FDB813] rounded-3xl -z-0 blur-xl opacity-50" />
              <div className="absolute -bottom-6 -right-6 w-40 h-40 bg-gradient-to-br from-[#006B3F] to-emerald-600 rounded-3xl -z-0 blur-xl opacity-30" />
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-600 mb-6 leading-relaxed text-lg">
              Rev. Obeng has been serving as the Head Pastor of ICGC Living Word Temple
              for over 15 years. His passion for teaching God's Word and raising up leaders has
              transformed countless lives.
            </p>

            <p className="text-slate-600 mb-8 leading-relaxed text-lg">
              With a heart for the local community and a vision for global impact, Pastor Emmanuel
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-slate-100 mb-8">
              ...
              <ul className="space-y-2 text-slate-600">
                <li className="flex items-start">
                  ...
                  <span>Master of Art - Peace and Human Resources</span>
                </li>
                <li className="flex items-start">
                  <GraduationCap className="w-5 h-5 mr-2 mt-0.5 text-[#006B3F]" />
                  <span>Bachelor of Theology - Central University</span>
                </li>
                <li className="flex items-start">
            ...
            <motion.button
              ...
              className="bg-gradient-to-r from-[#006B3F] to-emerald-600 text-white px-8 py-4 rounded-full font-bold shadow-xl hover:shadow-2xl transition-all flex items-center"
            >
              Schedule a Meeting
