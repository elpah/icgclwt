      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-white rounded-3xl p-8 shadow-lg mb-16 border border-slate-100"
          >
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative overflow-hidden bg-linear-to-br from-[#006B3F] to-emerald-700 rounded-[3rem] p-12 md:p-16 text-center text-white"
          >
            <motion.div
              animate={{ rotate: 360 }}
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-200 text-lg mb-10 max-w-2xl mx-auto">
                Subscribe to our newsletter to receive updates about upcoming events and
                announcements.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
                ...
                <motion.button
                  ...
                  className="w-full sm:w-auto bg-linear-to-r from-[#FFD700] to-[#FDB813] text-[#006B3F] px-8 py-4 rounded-full font-bold shadow-lg"
                >
                  Subscribe
                </motion.button>
              </div>
