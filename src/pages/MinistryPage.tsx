...
export const MinistryPage: React.FC<MinistryPageProps> = ({
  ...
  return <div className="min-h-screen bg-slate-50">
      ...
      <div className="relative h-[400px] overflow-hidden">
        <img src={ministry.headerImage} alt={ministry.name} className="w-full h-full object-cover" />
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            ...
            opacity: 1,
            x: 0
          }} onClick={() => navigateTo('home')} className="flex items-center space-x-2 text-white mb-6 hover:text-[#FFD700] transition-colors">
            ...
            y: 0
              ...
              <div className={`w-20 h-20 bg-gradient-to-br ${ministry.color} rounded-2xl flex items-center justify-center shadow-2xl`}>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            delay: 0.1
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {ministry.gallery.map((image, index) => <motion.div key={index} whileHover={{
                scale: 1.05
              }} className="relative h-48 rounded-2xl overflow-hidden shadow-md cursor-pointer group">
                    <img src={image} alt={`Gallery ${index + 1}`} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
          ...
          <div className="space-y-6">
            ...
            x: 0
              ...
              <div className="space-y-4">
                {ministry.meetings.map((meeting, index) => <div key={index} className="pb-4 border-b border-slate-100 last:border-0">
              ...
              scale: 0.98
            }} className="w-full mt-6 bg-gradient-to-r from-[#006B3F] to-emerald-600 text-white py-4 rounded-2xl font-bold hover:shadow-xl transition-all">
                Join This Ministry
              </motion.button>
            </motion.div>
          </div>
