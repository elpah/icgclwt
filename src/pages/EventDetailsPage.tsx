            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-slate-50 rounded-2xl p-6">
                  ...
                  <p className="text-slate-600">Unlimited seating available</p>
                </div>
                <div className="bg-slate-50 rounded-2xl p-6">
          ...
          <div>
            <div className="bg-linear-to-br from-[#006B3F] to-emerald-700 rounded-3xl p-8 text-white sticky top-24">
              ...
              <a
                ...
                className="block bg-[#FFD700] text-[#006B3F] py-4 rounded-2xl font-bold text-center hover:scale-[1.02] transition-transform"
              >
                Register Now
              </a>

              <button className="w-full mt-4 bg-white/10 py-4 rounded-2xl flex justify-center items-center gap-2 hover:bg-white/20 transition">
