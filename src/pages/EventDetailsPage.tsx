...
//               key={relEvent.id}
//               whileHover={{ y: -5 }}
//               onClick={() => navigate(`/event-details/${relEvent.id}`)}
//               className="cursor-pointer bg-white rounded-3xl shadow-lg overflow-hidden"
//             >
//               <img src={relEvent.image} alt={relEvent.title} className="h-48 w-full object-cover" />
//               <div className="p-6">
//                 <h3 className="text-xl font-bold">{relEvent.title}</h3>
//                 <p className="text-sm text-slate-600 mt-2 line-clamp-2">{relEvent.desc}</p>
//               </div>
//             </motion.div>
//           ))}
//         </div>
